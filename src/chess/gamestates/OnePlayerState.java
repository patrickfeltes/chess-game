...
public class OnePlayerState extends GameState {
    ...
    public void makeAIMove() {
        Move move = currentState.getAIMove();

        currentState.makeMove(BoardState.BLACK, move.getStartRow(), move.getStartCol(), move.getEndRow(), move.getEndCol());
